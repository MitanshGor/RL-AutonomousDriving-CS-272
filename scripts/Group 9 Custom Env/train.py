...
def make_env():
    ...
    env = Monitor(env, "./logs/dqn_narrow_lane")
    return env
...
def train_ppo(
    ...
    plt.ylabel('Reward')
    plt.title('PPO Group 9 Custom Env Learning Curve')
    plt.savefig(log_path+'/plots/ID15_group9_custom_learning_curve.png')
    plt.show()
    ...
    plt.ylabel('Reward')
    plt.title('PPO Group 9 Custom Env Performance Episodes')
    plt.savefig(log_path+'/plots/ID16_group9_custom_learning_curve.png')
    plt.show()
